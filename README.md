...
## Usage
### Running
The project is designed to run locally without having to execute any additional command, apart from restoring the **NuGet** packages and running the *Application* project.
